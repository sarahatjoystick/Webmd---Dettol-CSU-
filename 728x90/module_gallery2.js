...
function module_gallery2(obj, num) {
    this.obj = obj;
    this.num = num;
    this.large = false;
...
module_gallery2.prototype.createModule = function() {
...
module_gallery2.prototype.createTab = function() {
    ...
    var bn = document.createElement('div');
        bn.className = 'btn_next btn abs fa fa-caret-right prevnext animate';
        bn.style.color = this.obj.btn_color;

    var bp = document.createElement('div');
        bp.className = 'btn_prev btn abs fa fa-caret-left prevnext animate';
        bp.style.color = this.obj.btn_color;
...
module_gallery2.prototype.toggle = function(bool)
{
    var self = this;
    ...
    if(bool)
    {
        ...
        loadImage([ getURL(self.gallery[0][0]) ], function(e){
            ...
            removeClass(document.getElementById('header2'), 'start');
        });
    ...
    else
    {
        ...
        addClass(document.getElementById('header2'), 'start');
        setTimeout(function(){
...
module_gallery2.prototype.prevnext = function(bool) {
...
module_gallery2.prototype.loadSlide = function(num, bool, arg)
{
...
module_gallery2.prototype.autoGallery = function()
{
    var self = this;
...
module_gallery2.prototype.killMiniSlideShow = function()
{
    if(this.slideshow) {
