var config = {
	...
	module: [
		...
		{
			file: 'module_gallery2.js',
			mod_name: 'Discover Products',
			tab_class: 'gallery',
			bg: "i_gallery2_poster.jpg",
			photos: [
				[
					"i_gallery2_slide1.jpg",
				...
				[
					...
					"Dettol Disinfectant Spray can help protect your family from germs by helping prevent the spread of harmful bacteria and viruses. Dettol's unique formula is proven to kill 99.9% of bacteria and viruses on surfaces that you come into contact with every day."
				],
				[
					"i_gallery2_slide4.jpg",
					"Dettol Antibacterial Laundry Cleanser",
					"When you wash at temperatures below 60&deg;C, bacteria can survive in your washing machine and on your clothes. Add Dettol Antibacterial Laundry Cleanser to your wash to kill 99.9% of bacteria, so that you can be confident that your laundry is hygienically clean every time, whatever temperature you wash at (proven to work in rinse cycle temperatures as low as 15&deg;C)."
				]
			]
		},
		{
			file: 'module_facebook.js',
		 	mod_name: 'facebook',
		 	tab_class: 'fb',
			bg: "i_facebook_poster.jpg",
			exit: "https://www.facebook.com/missionforhealth"
		}
